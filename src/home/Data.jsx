...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Whos_Aslam
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Android Developer</h3>
            <p className="home__description">
              I'm a creative Mobile App Developer based in Pakistan. I create Polished Android Experiences </p>
            <a href="#contact" style={{background: 'black'}} className="button button--flex">Say Hello
            <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
